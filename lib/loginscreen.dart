        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                fieldTitle("İşçi ID"),
                customField("İşçi ID'nizi giriniz",idController, false),
                fieldTitle("Şifre"),
                customField("Şifrenizi giriniz",passController, true),
                GestureDetector(
                  onTap: () async {
                    ...
                    if(id.isEmpty) {
                      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                          content: Text("İşçi ID'si boş bırakılamaz!"),
                      ));
                      ...
                      try {
                        ...
                        if(e.toString() == "RangeError (index): Invalid value: Valid value range is empty: 0"){
                          setState(() {
                            error = "Girdiğiniz değerde bir İşçi ID'si bulunmamaktadır!";
                          });
                        } else {
                          setState(() {
